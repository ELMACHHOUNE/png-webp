...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Convert between WebP, PNG, JPEG, and AVIF formats",
    },
    {
    ...
    },
    {
      ...
      description:
        "Download individual files or a ZIP archive of all converted images",
    },
    {
      title: "Privacy First",
      icon: (
    ...
    <main className="w-full flex flex-col items-center px-2 relative overflow-hidden">
      ...
      <section className="w-full max-w-4xl text-center mt-16 mb-12 relative z-10 scroll-animate opacity-0 translate-y-8">
        ...
        <p className="text-xl sm:text-2xl text-gray-300 mb-8 leading-relaxed">
          ...
          and compression.
          <br />
          <span className="text-blue-400 font-semibold animate-glow">
        ...
        <div className="mt-12 grid grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-pink-400 animate-count-up">
              100%
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a
                    href="bsuiness.gotodev@gmail.com"
